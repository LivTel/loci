...
parser = argparse.ArgumentParser(prog='test_get_temperature.py',
                    description='Get the current detector temperature by sending a request to the API server.')
...
urlname = "http://" + str(args.ip_address) + ":" + str(args.port_number) + "/getTemperature"
