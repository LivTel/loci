...
parser = argparse.ArgumentParser(prog='test_get_exposure_progress.py',
                    description='Get the current progress of an underway exposure by sending a request to the API server.')
...
urlname = "http://" + str(args.ip_address) + ":" + str(args.port_number) + "/getExposureProgress"
