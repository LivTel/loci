...
parser = argparse.ArgumentParser(prog='test_get_camera_status.py',
                    description='Get the current camera status by sending a request to the API server.')
...
urlname = "http://" + str(args.ip_address) + ":" + str(args.port_number) + "/getCameraStatus"
